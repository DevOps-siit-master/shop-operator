...
const (
	DatabaseStandard DatabaseType = "standard" // PG
...
type ShopSpec struct {
	...
	// Availability selected by the admin (number of app instances)
	...
	// DisplayName is the human-readable shop name shown in the ShopHub UI
	// +optional
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &Shop{}, &ShopList{})
		return nil
	})
}
