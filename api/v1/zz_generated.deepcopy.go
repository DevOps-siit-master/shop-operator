...
func (in *ShopSpec) DeepCopyInto(out *ShopSpec) {
	*out = *in
	...
	out.DiscordChannel = in.DiscordChannel
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WalletConfig) DeepCopyInto(out *WalletConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WalletConfig.
func (in *WalletConfig) DeepCopy() *WalletConfig {
	if in == nil {
		return nil
	}
	out := new(WalletConfig)
	in.DeepCopyInto(out)
	return out
}
