...
type DiscordChannelSpec struct {
	...
	// Value represents discord's channel name
	ChannelName string `json:"channelName"`

	// Server identifier where channel belongs to
...
type DiscordChannelStatus struct {
	...
	// conditions represent the current state of the DiscordChannel resource.
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &DiscordChannel{}, &DiscordChannelList{})
		return nil
	})
}
